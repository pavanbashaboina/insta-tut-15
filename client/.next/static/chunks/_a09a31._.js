(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_a09a31._.js", {
...
const userSlice = (set, get)=>({
        signUpAction: async (fullname, username, email, password)=>{
            try {
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`http://localhost:5050/api/v1/signup`, {
                    fullname,
                    username,
                    email,
                    password
...
const AuthPage = ({ type })=>{
    _s();
    const { signUpAction } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$store$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
...
//# sourceMappingURL=_a09a31._.js.map